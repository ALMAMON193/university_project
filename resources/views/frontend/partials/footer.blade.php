        ...
        <div class="custom--row">
            ...
            <div class="footer--box logo-box">
                ...
                <ul class="social--icons">
                    {{-- twitter --}}
                    <li>
                        <a href="{{ $footer_cms[2]->link ? $footer_cms[2]->link : '#' }}">
                    ...
                    {{-- facebook --}}
                    <li>
                        <a href="{{ $footer_cms[3]->link ? $footer_cms[3]->link : '#' }}">
                    ...
                    {{-- instagram --}}
                    <li>
                        <a href="{{ $footer_cms[4]->link ? $footer_cms[4]->link : '#' }}">
                    ...
                    {{-- github --}}
                    <li>
                        <a href="{{ $footer_cms[5]->link ? $footer_cms[5]->link : '#' }}">
            ...
            <div class="footer--box">
                ...
                <ul>
                    ...
                    @foreach ($pageData as $index => $item)
                        <li>
                            <a href="{{ route('custom.page', ['page_slug' => $item->page_slug]) }}">{{ $item->page_title }} </a>
                        </li>
                    @endforeach
                </ul>
            </div>
