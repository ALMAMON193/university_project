...
@section('main--content')
    ...
    <main>
                                            ...
                                            <div class="bid--info">
                                                ...
                                                @else
                                                    <p>
                                                        ...
                                                        {{--  need to do later --}}
                                                        <span
                                                            class="auction_price_{{ $auction->id }}">${{ $auction->maxBid() ?? 0 }}</span>
                                                    </p>
                                                @endif
        ...
        <section class="cars--and--bids--area"
            style="background-image: url({{ asset('frontend/images/car-and-bids-bg.png') }}">
            <div class="container">
                <!-- section--title  -->
                <div class="section--title text-center" data-aos="fade-in" data-aos-duration="1500" data-aos-delay="100">
                    <h3 class="sec--title">Why Cars & Bids?</h3>
                </div>
                <div class="row">
                    <div class="col-md-3 mt_20" data-aos="fade-in" data-aos-duration="1200">
                        <!-- counter box  -->
                    ...
                    <div class="col-md-3 mt_20" data-aos="fade-in" data-aos-duration="1200" data-aos-delay="100">
                        <!-- counter box  -->
                    ...
                    <div class="col-md-3 mt_20" data-aos="fade-in" data-aos-duration="1200" data-aos-delay="200">
                        <!-- counter box  -->
                        <div class="counter--box">
                            <h4>
                    ...
                    <div class="col-md-3 mt_20" data-aos="fade-in" data-aos-duration="1200" data-aos-delay="300">
                        <!-- counter box  -->
                        <div class="counter--box">
                            <h4>
