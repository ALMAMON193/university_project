            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div style="display: flex;justify-content: end;"><a href="{{ route('dynamic.page.create') }}"
                                class="btn btn-primary">Add Dynamic Page</a></div>
                    </div>
...
@push('script')
    ...
    <script>
        ...
        function deleteItem(id) {
            var url = '{{ route('dynamic.page.delete', ':id') }}';
        ...
        function statusChange(id) {
            var url = '{{ route('dynamic.page.status', ':id') }}';
            $.ajax({
                type: "GET",
                url: url.replace(':id', id),
                success: function(resp) {
